...
ActiveRecord::Schema.define(version: 20170512115953) do
  ...
  create_table "annotations", force: :cascade do |t|
    ...
    t.index ["user_id", "sequence_id"], name: "index_annotations_on_user_id_and_sequence_id", unique: true, using: :btree
  end
  ...
  create_table "sequences", force: :cascade do |t|
    ...
    t.datetime "created_at",                        null: false
    t.datetime "updated_at",                        null: false
    t.index ["tubecam_device_id", "sequence_no"], name: "index_sequences_on_tubecam_device_id_and_sequence_no", unique: true, using: :btree
  end
